<?php
/**
 * pages/project_view.php — Project detail fragment
 */
...
if (!$p) {
    echo '<div class="alert alert-warning m-3"><i class="bi bi-exclamation-triangle me-2"></i>ไม่พบโครงการที่ต้องการ</div>';
    return;
}
...
$panelProg = project_progress_from_panels($id);
?>

<!-- Breadcrumb nav -->
<div class="mb-3">
  <a href="#/projects" class="text-decoration-none small text-muted">
    <i class="bi bi-arrow-left me-1"></i>กลับรายการ Project
  </a>
</div>
...
<div class="view-head">
  ...
  <div class="d-flex gap-2 flex-wrap">
    <a href="#/reports/select/<?= (int)$id ?>" class="btn btn-info text-white">
      <i class="bi bi-image"></i> Overview Report
    </a>
    <a href="#/projects/edit/<?= (int)$id ?>" class="btn btn-primary">
      <i class="bi bi-pencil"></i> แก้ไข
    </a>
    <a href="#" class="btn btn-outline-dark"
       data-spa-fullscreen="print_report.php?id=<?= (int)$id ?>&fragment=1"
       data-spa-title="รายงานโครงการ <?= e($p['project_no']) ?>">
      <i class="bi bi-printer"></i> พิมพ์
    </a>
    <button class="btn btn-outline-danger"
            onclick="SPA.confirmDelete('ยืนยันการลบโครงการ <?= e($p['project_no']) ?>?','api/project_delete.php?id=<?= (int)$id ?>','/projects')">
      <i class="bi bi-trash"></i> ลบ
    </button>
    <a href="#/projects" class="btn btn-light">กลับ</a>
  </div>
</div>
...
<!-- Panel Tracking -->
<div id="panel-section" class="panel mt-1">
  <div class="panel-head">
    ...
    <?php endif; ?>
    <a href="#/panels/add?project_id=<?= (int)$id ?>" class="ms-auto btn btn-sm btn-success">
  ...
  <div class="panel-body p-0">
    <div class="table-responsive">
      <table class="table table-hover align-middle mb-0 data-table">
        <thead>
          <tr>
            <th>Panel No.</th><th>ชื่อตู้ / ประเภท</th><th>Group</th>
            <th>กำหนดส่ง</th><th>วันส่งจริง</th>
          ...
          <?php else: foreach ($panels as $pn):
            ...
            <tr>
              ...
              <td class="text-center text-nowrap">
                <a href="#/panels/edit/<?= (int)$pn['id'] ?>" class="btn btn-sm btn-light" title="แก้ไข">
                  <i class="bi bi-pencil"></i>
                </a>
                <button class="btn btn-sm btn-light text-danger" title="ลบ"
                        onclick="SPA.confirmDelete('ยืนยันการลบตู้ <?= e($pn['panel_no']) ?>?','api/panel_delete.php?id=<?= (int)$pn['id'] ?>','/projects/view/<?= (int)$id ?>')">
